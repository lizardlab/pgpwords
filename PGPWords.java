...
public class PGPWords{
	public static void main(String args[]){
		int index;
        
        // set it to look like native UI
        try{
		...
		// print out the word list for the fingerprint
		for(int x = 0; x < wordlist.size(); x++){
			authCode.append(wordlist.get(x));
			authCode.append("   ");
			// make it four words per line for easy reading
			if((x + 1) % 4 == 0){
				authCode.append("\n");
			}
		}
        JOptionPane.showMessageDialog(null, "The PGP wordlist encoded fingerprint is:\n" + authCode, "PGP Words", JOptionPane.INFORMATION_MESSAGE);
	}
}