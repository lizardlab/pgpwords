...
public class PGPWordList{
	public static void main(String args[]){
		...
		int index;
		System.out.println("Please input the PGP fingerprint");
		// get the PGP finger print
		String fingerprint = keyboard.nextLine();
		// clean it from formatting
		...
		System.out.println("The PGP wordlist encoded fingerprint is:");
